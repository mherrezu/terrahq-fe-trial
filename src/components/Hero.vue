<template>
  <section
    ...
    <img v-if="shapes.shape_1" :src="shapes.shape_1" class="absolute left-0 bottom-0 h-28 md:h-40 lg:h-82.8 lg:w-110.8" />
    <img v-if="shapes.shape_2" :src="shapes.shape_2" class="absolute right-0 top-0 h-28 md:h-40 lg:h-82.8 lg:w-110.8" />
